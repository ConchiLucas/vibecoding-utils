...
export default function Layout() {
  ...
  const isFullWidthRoute = location.pathname === '/projects' || location.pathname === '/script-manager' || location.pathname === '/agile-request' || location.pathname === '/agile-table-samples';
