...
type TbGenerateProjectInstance struct {
	...
	GeneratePlaceholderValues string `json:"generatePlaceholderValues" form:"generatePlaceholderValues" gorm:"column:generate_placeholder_values;type:text;comment:生成代码上次占位符参数"`
}
